<template>
  <div>
    <h1 class="text-center">BERGABUNG DENGAN KOMUNITAS</h1>
    <h4 class="text-center">Tempat Anda para petani saling sharing seputar dunia pertanian</h4>
          ...
          <div class="col-md-4" v-if="response" v-for="repo in response" >
            <div class="box box-widget widget-user">
              <div class="widget-user-header bg-aqua-active text-center">
                <h3 class="widget-user-username center-text">Komunitas Petani Cabai Garut</h3>
              </div>
              <div class="widget-user-image">
                <img class="img-circle" src="../../assets/petani5.png" alt="repo.owner.login + ' Avatar'">
              </div>
                ...
                <div class="row">
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      ...
                      <span class="description-text">Popularitas</span>
                    </div>
                  </div>
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
